...
class PrayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post prayers_url, params: { prayer: { description: @prayer.description, email: @prayer.email, firstName: @prayer.firstName, phoneNumber: @prayer.phoneNumber, surname: @prayer.surname, user_id: @prayer.user_id } }
    end
  ...
  test "should update prayer" do
    patch prayer_url(@prayer), params: { prayer: { description: @prayer.description, email: @prayer.email, firstName: @prayer.firstName, phoneNumber: @prayer.phoneNumber, surname: @prayer.surname, user_id: @prayer.user_id } }
